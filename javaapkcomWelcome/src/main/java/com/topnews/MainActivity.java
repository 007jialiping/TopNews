...
//				overridePendingTransition ：使用动画形式，从一个Activity跳至另一个Activity
				overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
			}
		});
//		侧边栏监听事件  SlidingMenu
//		top_head 点击 触发左侧抽屉（若没有显示，则显示，若已显示，则点击后消失）
//		top_more 点击 触发右侧抽屉
...
//		当自定义栏目发生变化时，重新加载新的栏目
		setChangelView();
	}
	/** 
	 *  当栏目项发生变化时候调用  分别为 获取栏目数，初始化栏目项，初始化Fragment
	 * */
...
//			根据data（栏目导航数据）显示fragment，将所有栏目对应的Fragment存入数组
